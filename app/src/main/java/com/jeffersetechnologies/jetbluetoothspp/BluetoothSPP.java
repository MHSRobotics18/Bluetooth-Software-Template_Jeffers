...
/**
 * JeT Bluetooth Serial Port Protocol (SPP)
 * Transfers text between a simple SPP device such as an adapter for an Arduino or Raspberry Pi.
 */
public class BluetoothSPP {
    ...
    /**
     * Write to the ConnectedThread asynchronous
     *
